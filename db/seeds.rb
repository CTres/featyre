...
user_feature = user2.owned_features.create title: "Asana Ruby Wrapper", tag_list: "ruby, httparty, rails 3", user_id: '1', description: 'a simple wrapper for the asana API - takes oauth token', 
...
user_feature = user3.owned_features.create title: "mobile web app", url: 'mobile.github.com', description: 'a slick new mobile interface for github',  tag_list: "html, css", user_id: '1', text: <<-FEATURE
here are the best practices of the asana ruby wrapper feature that we just shipped. Use httparty for complete flexibility. 
FEATURE